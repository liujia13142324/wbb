...
public class ImageTest {
	...
	@Test
	public void TestImage() throws IOException, MetadataException, JpegProcessingException {
	...
	private void uploadPicture(File srcFile, File dstFile) {
		try {
	...
	private BufferedImage doRotate(BufferedImage src, int angel) {
	...
	private int getRotateAngle(File imgFile) {
		int angel = 0;
		Metadata metadata;
